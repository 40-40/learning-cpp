...
// In order to set the values for name and age you must use cin and the extraction operator >> to allow the employee to enter their name and age in that order separated by a single space. 
...
void employee_profile() {
    ...
    // set the values for name and age you must use cin and the extraction operator >>
    // allow the employee to enter their name and age in that order
    cin >> name >> age;
